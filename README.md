...
Follow the [installation instructions](#installation-instructions), and pixi will do the rest of the installation work, when you run the example script for the first time: 
```
...
pixi will handle the rest of the work, when you run a script for the first time using `pixi run <script.py>`

See `pixi --help`, for more info.
